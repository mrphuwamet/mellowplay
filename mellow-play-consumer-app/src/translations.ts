...
export const translations = {
  en: {
    ...
    login: {
      ...
      resetPin: 'Reset PIN',
      resetPinDesc: 'Enter your phone number to receive OTP',
      newPin: 'New PIN',
      confirmNewPin: 'Confirm New PIN',
      pinMismatch: 'PINs do not match',
      otpSent: 'OTP sent successfully',
      orContinueWith: 'or continue with',
      verifyingGoogle: 'Verifying with Google...',
    ...
    register: {
      ...
      stepPinCreate: 'Create PIN',
      stepPinCreateDesc: 'Set a 6-digit PIN for quick login',
      stepPinConfirm: 'Confirm PIN',
      stepPinConfirmDesc: 'Please enter your PIN again',
      pinNotMatch: 'PINs do not match. Please try again.',
      stepAvatar: 'Profile Picture',
...
By clicking "Accept", you acknowledge that you have read and understood the details outlined in this Privacy Notice, and you consent to the Company's processing of your personal data as specified above.`,
      ...
      childrenInfoTitle: 'Children Information',
      prefixLabel: 'Title',
      prefixMr: 'Mr.',
      prefixMrs: 'Mrs.',
      prefixMiss: 'Miss',
      ...
      resendWaitLabel: 'Please wait {{seconds}} seconds to resend',
      back: 'Back',
      selectCountry: 'Select Country',
      searchCountry: 'Search country or code...',
      noCountryFound: 'No country found',
      removeChildTitle: 'Remove this child?',
      removeChildDesc: 'This child\'s information will be removed from the form.',
      removeChildConfirm: 'Yes, Remove',
      removeChildCancel: 'Cancel',
      addChildPageTitle: 'Add Family Member',
      addChildPageDesc: 'Tell us about your family members to get started',
      requiredPrefix: 'Please select a title',
      ...
      requiredNickname: 'Please enter nickname',
      requiredGender: 'Please select gender',
      requiredDob: 'Please select date of birth',
      requiredRelation: 'Please specify relationship'
    },
    home: {
      level: 'Level',
    ...
    album: {
      ...
      noPhotosDesc: 'Book a class to start collecting memories!',
      ...
      maxSelection: 'You can select up to 30 photos at a time',
      groupTimeline: 'Timeline',
      groupAll: 'All',
      pickDate: 'Pick a date',
      allDates: 'All dates',
      noPhotosForDate: 'No photos in this range',
      fromDate: 'From',
      toDate: 'To',
      apply: 'Apply',
      clearDates: 'Clear',
  ...
  th: {
    ...
    login: {
      ...
      resetPinDesc: 'กรอกเบอร์โทรศัพท์เพื่อรับรหัส OTP',
      newPin: 'รหัส PIN ใหม่',
      confirmNewPin: 'ยืนยันรหัส PIN ใหม่',
      pinMismatch: 'รหัส PIN ไม่ตรงกัน',
      otpSent: 'ส่งรหัส OTP สำเร็จ',
      orContinueWith: 'หรือดำเนินการต่อด้วย',
      verifyingGoogle: 'กำลังตรวจสอบกับ Google...',
      attemptsRemaining: 'ครั้งที่เหลือ',
      tooManyAttempts: 'กรอกผิดเกินกำหนด กรุณาลองใหม่ภายหลัง',
      tooManyAttemptsTitle: 'กรอกผิดเกินกำหนด',
      tryAgainIn: 'กรุณาลองใหม่อีกครั้งใน',
      seconds: 'วินาที',
    },
    register: {
      stepInfo: 'สร้างบัญชี',
      ...
      firstNameEn: 'ชื่อจริง (ภาษาอังกฤษ)',
      firstNameEnLabel: 'ชื่อจริง (ภาษาอังกฤษ)',
      ...
      stepPinCreate: 'สร้างพิน',
      stepPinCreateDesc: 'ตั้งรหัส PIN 6 หลักเพื่อเข้าสู่ระบบอย่างรวดเร็ว',
      stepPinConfirm: 'ยืนยันพิน',
      stepPinConfirmDesc: 'กรุณากรอกรหัส PIN อีกครั้ง',
      pinNotMatch: 'รหัส PIN ไม่ตรงกัน กรุณาลองใหม่อีกครั้ง',
      stepAvatar: 'รูปโปรไฟล์',
...
การที่ท่านคลิกยอมรับ ถือว่าท่านได้รับทราบและทำความเข้าใจรายละเอียดในประกาศความเป็นส่วนตัวฉบับนี้ และยินยอมให้บริษัทฯ ประมวลผลข้อมูลส่วนบุคคลตามที่ระบุไว้ข้างต้น`,
      ...
      parentInfoTitle: 'ข้อมูลผู้ปกครอง',
      childrenInfoTitle: 'ข้อมูลเด็ก',
      ...
      phoneCountryCode: '+66',
      referenceCode: 'รหัสอ้างอิง (Ref)',
      resendWaitLabel: 'กรุณารอ {{seconds}} วินาที เพื่อส่งรหัสใหม่',
      back: 'ย้อนกลับ',
      selectCountry: 'เลือกประเทศ',
      searchCountry: 'ค้นหาประเทศหรือรหัส...',
      noCountryFound: 'ไม่พบประเทศที่ค้นหา',
      removeChildTitle: 'ลบข้อมูลเด็กคนนี้?',
      removeChildDesc: 'ข้อมูลของเด็กคนนี้จะถูกลบออกจากแบบฟอร์ม',
      removeChildConfirm: 'ใช่, ลบข้อมูล',
      removeChildCancel: 'ยกเลิก',
      addChildPageTitle: 'เพิ่มสมาชิกครอบครัว',
      addChildPageDesc: 'บอกเราเกี่ยวกับสมาชิกครอบครัวของคุณเพื่อเริ่มต้นใช้งาน',
      requiredPrefix: 'กรุณาเลือกคำนำหน้า',
      requiredFirstName: 'กรุณากรอกชื่อ',
      requiredLastName: 'กรุณากรอกนามสกุล',
      requiredPhone: 'กรุณากรอกเบอร์โทรศัพท์',
      requiredEmail: 'กรุณากรอกอีเมล',
      requiredNickname: 'กรุณากรอกชื่อเล่น',
      requiredGender: 'กรุณาเลือกเพศ',
      requiredDob: 'กรุณาเลือกวันเกิด',
      requiredRelation: 'กรุณาระบุความสัมพันธ์'
    },
    home: {
      level: 'ระดับ',
    ...
    album: {
      ...
      share: 'แชร์',
      close: 'ปิด',
      noPhotosTitle: 'ยังไม่มีภาพถ่าย',
      noPhotosDesc: 'มาจองคลาสกันเถอะ เพื่อเริ่มเก็บความทรงจำดีๆ!',
      bookNow: 'จองคลาส',
      select: 'เลือกรูป',
      cancel: 'ยกเลิก',
      selectAll: 'เลือกทั้งหมด',
      download: 'ดาวน์โหลด',
      downloadSelected: 'ดาวน์โหลด',
      maxSelection: 'เลือกได้สูงสุดครั้งละ 30 รูป',
      groupTimeline: 'ไทม์ไลน์',
      groupAll: 'ทั้งหมด',
      pickDate: 'เลือกวันที่',
      allDates: 'ดูทุกวัน',
      noPhotosForDate: 'ไม่มีภาพถ่ายในช่วงวันที่เลือก',
      fromDate: 'จากวันที่',
      toDate: 'ถึงวันที่',
      apply: 'ค้นหา',
