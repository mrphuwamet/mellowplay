...
const FieldHint: React.FC<{ message?: string }> = ({ message }) =>
  message ? (
    <div className="absolute -top-1.5 right-0 -translate-y-full z-20 flex items-center gap-1.5 px-3 py-1.5 max-w-[220px] bg-red-500 text-white rounded-xl text-[11px] font-bold shadow-lg animate-in fade-in slide-in-from-bottom-1 duration-150 pointer-events-none">
