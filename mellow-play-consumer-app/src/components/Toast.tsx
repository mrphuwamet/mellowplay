...
export function Toast({ message, type = 'error', onClose, duration = 5000 }: ToastProps) {
  ...
  return (
    <div className={`fixed top-8 left-1/2 -translate-x-1/2 z-[100] w-[90%] max-w-sm p-4 rounded-2xl shadow-xl border text-sm font-bold flex items-center justify-between animate-in fade-in slide-in-from-top-8 duration-300 ${bgColor}`}>
