...
add(0, 's1_with', 'checkbox', 'ท่านเข้าร่วมกิจกรรมกับใคร (ตอบได้มากกว่า 1 ข้อ)', 1,
  plain(['พ่อ/แม่', 'ลูก', 'ปู่ ย่า ตา ยาย', 'พี่/น้อง', 'อื่น ๆ']));
// The paper's "อื่น ๆ ระบุ ......" — a checkbox has nowhere to type, so the
// blank line becomes its own optional field rather than being dropped.
add(0, 's1_with_other', 'text', 'หากตอบ "อื่น ๆ" กรุณาระบุ', 0);
